export function renderHeaders() {
  ...
  <div class="header-left">
        ...
        <div class="header-right">
          <nav class="nav-menu">
            <a class="nav-item home-page-nav-item" title="Go back to the home page" href="homePage.html">
              Home
            </a>
            <a class="nav-item about-me-nav-item" href="aboutMe.html">
              About me
            </a>
            <div class="nav-seperator"></div>
            <a class="nav-item my-services-nav-item">
              My services
            </a>
  ...
  function renderHamburgerMenu() {
    let html = `
      ...
      <div class="hamburger-menu-page-options">
        ...
        <a class="hamburger-menu-page-option my-services-nav-item">My services</a>
